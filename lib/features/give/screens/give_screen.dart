...
class _GiveScreenState extends State<GiveScreen>
  ...
  String recordedTime = '00:00'; // To display the time in mm:ss format
  int elapsedTimeInSeconds = 0; // Elapsed time in seconds
  ...
  void initState() {
    ...
    _initializeCamera();
// Initialize the animation controller for the circular progress
  ...
  Future<void> _initializeCamera() async {
    try {
      ...
      //open only fromt camera for recoring
  ...
  Future<void> _startRecording() async {
    ...
    _elapsedTimeTimer = Timer.periodic(const Duration(seconds: 1), (timer) {
      setState(() {
        ...
        recordedTime = _formatTime(elapsedTimeInSeconds);
      });
    });

    // Start a timer to stop recording after 5 seconds
...
// Stop the elapsed time timer
      ...
      ..initialize().then((_) {
        ...
        _videoPlayerController.addListener(() {
          if (!_videoPlayerController.value.isPlaying &&
            ...
            setState(() {
              isVideoPlayed = false; // Video has finished playing
            });
          }
        });
      });
  ...
  String _formatTime(int seconds) {
    ...
    return '${_padTime(minutes)}:${_padTime(remainingSeconds)}';
  }
          ...
          actions: <Widget>[
            ...
            CupertinoDialogAction(
              ...
              onPressed: () {
                ...
                ); // navigating to home after discard video
  ...
  void _playVideo() {
    setState(() {
      isVideoPlayed = true; // Reset flag so play button hides again
    });
    _videoPlayerController.play();
  }
                  ...
                  if (!isVideoInitialized)
                    Row(
                      ...
                      children: [
                        ...
                        //               ? Colors.white
                        //               : Colors
                        //                   .red, // White for stop, red for record
                        //         ),
                        //       ],
                        //     ),
                        //   ),
